...
```sh
npm run verify       # build + check + check:docs + every test below (the CI gate)
...
## The seawater calculator (`packages/teos10/`, `/data/seawater/`)
...
a coefficient multiplied by a normalised pressure moves the answer less than
